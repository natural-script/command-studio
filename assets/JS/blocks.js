	...
	updateShape_: function () {
		...
		for (var i = 0; i < this.itemCount_; i++) {
			if (!this.getInput('ADD' + i)) {
				if (i == 0) {
					this.appendDummyInput()
						.appendField('Dynamic Data')
						.appendField(new Blockly.FieldTextInput("options"), "data_id");
					this.appendDummyInput()
						.appendField(new Blockly.FieldCheckbox("FALSE"), "grouped")
						.appendField("Grouped");
					this.appendDummyInput()
